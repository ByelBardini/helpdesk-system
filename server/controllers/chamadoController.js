...
export const getChamadosUsuario = (req, res) => {
    ...
    db.query(sql, [usuario_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao buscar chamados por usuário." });
        }
        res.status(200).json(results);
    });
}
...
export const getChamadosSetor = (req, res) => {
    ...
    db.query(sql, [setor_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao buscar chamados por setor." });
        }
        res.status(200).json(results);
    });
}
...
export const putStatusChamado = (req,res) => {
    ...
    db.query(sql, [chamado_status_id, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar status do chamado." });
        }
        res.status(200).json({ message: "Status do chamado modificado com sucesso!" });
    });
}
...
export const putPrioridadeChamado = (req, res) => {
    ...
    if (!chamado_prioridade_id) {
        return res.status(400).json({ message: "Prioridade do chamado é obrigatória!" });
    }
    ...
    db.query(sql, [chamado_prioridade_id, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar prioridade do chamado." });
        }
        res.status(200).json({ message: "Prioridade do chamado modificada com sucesso!" });
    });
}
...
export const putImpactoChamado = (req, res) => {
    ...
    if (!chamado_impacto_id) {
        return res.status(400).json({ message: "Impacto do chamado é obrigatório!" });
    }
    ...
    db.query(sql, [chamado_impacto_id, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar impacto do chamado." });
        }
        res.status(200).json({ message: "Impacto do chamado modificado com sucesso!" });
    });
}
...
export const putResponsavelChamado = (req, res) => {
    ...
    if (!chamado_responsavel_id) {
        return res.status(400).json({ message: "Responsável do chamado é obrigatório!" });
    }
    ...
    db.query(sql, [chamado_responsavel_id, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar responsável do chamado." });
        }
        res.status(200).json({ message: "Responsável do chamado modificado com sucesso!" });
    });
}
...
export const putTipoChamado = (req, res) => {
    ...
    db.query(sql, [chamado_tipo_id, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar tipo do chamado." });
        }
        res.status(200).json({ message: "Tipo do chamado modificado com sucesso!" });
    });
}
...
export const putPrazoChamado = (req, res) => {
    ...
    db.query(sql, [chamado_prazo, chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao modificar prazo do chamado." });
        }
        res.status(200).json({ message: "Prazo do chamado modificado com sucesso!" });
    });
}
...
export const finalizaChamado = (req, res) => {
    ...
    db.query(sql, [chamado_id], (err, results) => {
        if (err) {
            ...
            return res.status(500).json({ error: "Erro ao finalizar status do chamado." });
        }
    })
    db.query(sql2, [chamado_id], (err, results) => {
        if (err) {
            console.log("Erro ao atualizar data de fechamento do chamado: ", err);
            return res.status(500).json({ error: "Erro ao atualizar data de fechamento do chamado." });
        }
...
export const abreChamado = (req, res) => {
    const { chamado_usuario_id, chamado_setor_id, chamado_categoria_id, chamado_tipo, chamado_motivo, chamado_descricao } = req.body;

    if (!chamado_usuario_id || !chamado_setor_id || !chamado_categoria_id || !chamado_tipo || !chamado_motivo || !chamado_descricao) {
    ...
    db.query(sql, [chamado_usuario_id, chamado_setor_id, chamado_categoria_id, chamado_tipo, chamado_motivo, chamado_descricao], (err, results) => {
        if (err) {
